<?php 
    ...
    if(isset($_POST["btn_addindustry"])){
        ...
        $con = new connec();
        $sql = "INSERT INTO industry VALUES (0,' $industry')";
                    ...
                    <hr>
                        <!-- form add cinema -->
                            <div class="form-group">
                                ...
                                <input type="text" name="industry" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Cinema Name">
                            </div>
                            <div class="modal-group" style="text-align: right;">
                                <button type="submit" name="btn_addindustry" class="btn" style="background-image: linear-gradient(to right, #bdc3c7, #2c3e50); color:white;">Insert</button>
                            </div>
                            </form>
                        </div>
                    </div>
