...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-sm navbar-dark" style="background-image: linear-gradient(to right, #bdc3c7, #2c3e50);">
    <a class="navbar-brand" href="index.php"><img src="images/icon247.png" style ="width:60px;"></a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0" style="font-family: Montserrat, sans-serif;" >
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: white;"><i class="fas fa-money-bill-wave-alt"></i>MOVIE</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="offers.php" style="color: white;">OFFER</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="booking.php" style="color: white;">BOOKING TICKET</a>
            </li>
